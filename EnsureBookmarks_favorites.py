...
MARKED_FOLDER = "/Library/Application Support/FEG/bookmarks"
MANAGED_BOOKMARKS = os.path.join(MARKED_FOLDER, "corporate_favorites.plist")
EXPLANATION = os.path.join(MARKED_FOLDER, "explanation.html")
USER_FOLDER = os.path.expanduser("~/Library/Application Support/marked/Corporate Favorites")
